...
// Formules de prière en arabe avec translittération et traduction
export const prayerFormulas: PrayerFormula[] = [
  {
    id: 1,
...
// Fonction pour obtenir une formule aléatoire
export const getRandomFormula = (): PrayerFormula => {
  const randomIndex = Math.floor(Math.random() * prayerFormulas.length);
  return prayerFormulas[randomIndex];
};
