...
interface ShareDrawerContentProps {
  prayer?: PrayerData;
  reminder?: any; // Type pour les rappels
  onClose: () => void;
}
          ...
          <View style={styles.deceasedInfo}>
            ...
            <View style={styles.detailsRow}>
              ...
              <Text style={[
                ...
                {prayer?.location || reminder?.location}
              </Text>
            </View>
          </View>
